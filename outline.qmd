...
1. Finding Python (Python basics for data science)
...
![Course 1: Finding Python for Data Science](images/python-course-card.png) 

# Course 1: Finding Python for Data Science
